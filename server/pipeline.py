...
def create_aiavatar_app(settings: Settings):
    ...
    return AIAvatarWebSocketServer(
        ...
        ptt_voice_auth_enabled=settings.ptt_voice_auth_enabled,
        ptt_wakeword_enabled=settings.ptt_wakeword_enabled,
        ptt_addressing_enabled=settings.ptt_addressing_enabled,
        ...
        debug_report_enabled=settings.debug_report_enabled,
